...
#pragma mark - SVPullToRefreshView
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self)
    {
        ...
        self.textColor = [UIColor darkGrayColor];//创建了titleLabel、subTitleLabel
        ...
        self.subtitles = [NSMutableArray arrayWithObjects:@"1", @"2", @"3", @"4", nil];
