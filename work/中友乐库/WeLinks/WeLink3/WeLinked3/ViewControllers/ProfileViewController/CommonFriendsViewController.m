...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if(descLabel == nil)
    {
        descLabel = [[RCLabel alloc]initWithFrame:CGRectMake(70, 6, 230, 53)];
    ...
    [str appendFormat:@"<p   lineSpacing=0><font color='#464646' face='FZLTZHK--GBK1-0' size=14>%@</font></p>",info.name];
    if(info.company != nil && [info.company length]>0)
    {
        [str appendFormat:@"\n<p lineSpacing=3><font color='#999999' size=11>%@ %@</font></p>",info.company,info.job];
    }
    else
    {
        [str appendFormat:@"\n<p lineSpacing=3><font color='#999999' size=11>%@</font></p>",info.job];
    }
    if(info.descriptions != nil && [info.descriptions length]>0)
    {  
        [str appendFormat:@"\n<p lineSpacing=3><font color='#999999' size=11>%@</font></p>",info.descriptions];
    }
    else
    {
        [str appendFormat:@"\n<p lineSpacing=3><font color='#999999' size=11>暂无描述</font></p>"];
    }
