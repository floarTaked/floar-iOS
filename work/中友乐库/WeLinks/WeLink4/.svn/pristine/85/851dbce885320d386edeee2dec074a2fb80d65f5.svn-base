...
@implementation VcardGeneratorBase
...
- (id) init
{
    ...
    if (self)
    {
        ...
        {
            knownLabelArray_ = [NSArray arrayWithObjects:vN, vFN, vPHOTO, vADR, vTEL, vEMAIL, vNICKNAME, vTITLE, vORG, vNOTE, vURL, vBDAY, vPREF, @"CHARSET", @"ENCODING", nil];
        }
    }
    return self;
}
