...
- (void)viewDidLoad
{
    ...
    [self.navigationItem setTitleString:@"职脉标签"];
    ...
    if(self.tagType == 1)
    {
        //1职业标签"jobTags" : null, (职业标签)
        tags = [UserInfo myselfInstance].jobTags;
    }
    else if (self.tagType == 2)
    {
        //2业务标签 "tags" : null, (业务标签)
        tags = [UserInfo myselfInstance].tags;
    }
...
-(void)save:(id)sender
{
    ...
    {
        //1职业标签"jobTags" : null, (职业标签)
        [dic setObject:str==nil?@"":str forKey:@"jobTags"];
    }
    else if (self.tagType == 2)
    {
        //2业务标签 "tags" : null, (业务标签)
