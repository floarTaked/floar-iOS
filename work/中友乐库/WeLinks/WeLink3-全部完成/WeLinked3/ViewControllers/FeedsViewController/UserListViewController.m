...
- (void)viewDidLoad
{
    ...
    [self.navigationItem setTitleViewWithText:@"用户列表"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    CustomMarginCellView *cell = (CustomMarginCellView*)[tableView dequeueReusableCellWithIdentifier:CellIdentifier];
    if(cell == nil)
    {
        cell = [[CustomMarginCellView alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:CellIdentifier];
        cell.accessoryType = UITableViewCellAccessoryNone;
        cell.selectionStyle = UITableViewCellSelectionStyleNone;
        [cell setSelectedPosition:CustomCellBackgroundViewPositionMiddle];
    }
    UserInfo* info = [_userList objectAtIndex:indexPath.row];
...
-(void)customCell:(UITableViewCell*)cell info:(UserInfo*)info
{
    ...
    if(button == nil)
    {
        ...
        button.tag = 5;
        button.x = cell.width - button.width - 10;
