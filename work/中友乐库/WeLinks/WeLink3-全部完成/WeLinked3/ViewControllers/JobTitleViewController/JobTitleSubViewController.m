...
@interface JobTitleSubViewController ()
@property (weak, nonatomic) IBOutlet UITableView *tableView;

@end

@implementation JobTitleSubViewController
...
{
    [[NSNotificationCenter defaultCenter] postNotificationName:kDidSelectJobTitle object:@"北京"];
}
