...
token,weiboId,weiboName,weiboToken,createTime,education,sex,friendType,salaryStatus,phoneStatus,tags,descriptions,blog;
-(id)init
{
    self = [super init];
    if(self)
...
-(NSString*)job
{
    ...
    {
        JobObject* j = [[LogicManager sharedInstance] getPublicObject:jobCode type:Job];
        return j.name;
    }
}
