...
//                 {
//                     [dictArray addObject:[self getTimeString:article.publishTime]];
//                     NSMutableArray *arr = [[NSMutableArray alloc] init];
//                     [arr addObject:article];
//                     NSDictionary *dic = [[NSDictionary alloc] init];
//                     [dic setValue:arr forKeyPath:[self getTimeString:article.publishTime]];
//                 }
//                 else
//                 {
//                     for (NSString *str in dictArray)
//                     {
//                         if (![str isEqualToString:[self getTimeString:article.publishTime]])
//                         {
//                             [dictArray addObject:[self getTimeString:article.publishTime]];
//                         }
//                     }
