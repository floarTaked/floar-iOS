    ...
    if(adapter == nil)
    {
        switch (self.msgType)
        {
            ...
            case TipMessage:
            {
                ...
                break;
            case PostRecommendedMessage:
            {
                adapter = [[PostRecommendedMessageItem alloc]init];
            }
                break;
            case PostMessage:
            {
                adapter = [[PostMessageItem alloc]init];
            }
                break;
            case ForwardingPostMessage:
            {
                adapter = [[ForwardingPostMessageItem alloc]init];
            }
                break;
            default:
                break;
