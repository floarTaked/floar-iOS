...
unsigned long hexColorFromString(NSString *string)
{
    ...
    {
        //string == "0x414146"
        colorValue = strtoul([string UTF8String], 0, 16);
    }
    else
    {
        //string == "#414146"
        ...
        colorValue = strtoul([str UTF8String], 0, 16);
    }
    return colorValue;
}
...
NSString * hexColorToString(UIColor *color)
{
    ...
    NSString *r = [NSString stringWithFormat:@"%@",octNumToHex(cs[0]*255)];
    NSString *g = [NSString stringWithFormat:@"%@",octNumToHex(cs[1]*255)];
    NSString *b = [NSString stringWithFormat:@"%@",octNumToHex(cs[2]*255)];
    return [NSString stringWithFormat:@"#%@%@%@",r,g,b];
}

//十进制转十六进制
NSString *octNumToHex(int tmpid)
{
    NSString *endtmp=@"";
