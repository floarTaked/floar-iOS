                             ...
                             selector:(SEL)selector
{
    ...
    if (title && ![title isEqualToString:@""])
    {
        ...
        [customBtn.titleLabel setFont:[UIFont boldSystemFontOfSize:16.0]];
...
-(void)setEnable:(int)side enable:(BOOL)enable
{
    if(side == 0)
    {
        //left
        self.leftBarButtonItem.enabled = enable;
    }
    else if (side == 1)
    {
        self.rightBarButtonItem.enabled = enable;
    }
}
@end
