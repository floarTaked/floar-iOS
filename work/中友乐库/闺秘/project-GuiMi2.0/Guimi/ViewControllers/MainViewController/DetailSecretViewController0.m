...
#import "DetailSecretViewController0.h"
...
@interface DetailSecretViewController0 ()<UITableViewDataSource,UITableViewDelegate,UINavigationControllerDelegate,UITextFieldDelegate>
{
    CGPoint pointOffset;
    UIImageView *imgView;
    UIButton *sendBtn;
...
@implementation DetailSecretViewController0
                ...
                if (0 == result)
                {
                    ...
                    else
                    {
                        ...
                        for (int i = 0; i < num; i++)
                        {
                            ...
                            [comment analyzePackageForComment:returnPack];
