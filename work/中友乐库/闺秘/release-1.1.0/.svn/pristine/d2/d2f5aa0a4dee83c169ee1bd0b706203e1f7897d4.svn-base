...
// public properties
@synthesize pullToRefreshActionHandler,lastUpdatedDate, dateFormatter,textColor/*activityIndicatorViewStyle,arrowColor*/;

@synthesize state = _state;
@synthesize scrollView = _scrollView;
@synthesize showsPullToRefresh = _showsPullToRefresh;
//@synthesize arrow = _arrow;
@synthesize gifImgView = _gifImgView;
...
//        self.activityIndicatorViewStyle = UIActivityIndicatorViewStyleWhite;
        ...
        float red   = (0x999999 & 0xFF0000)>>16;
        float green = (0x999999 & 0x00FF00)>>8;
        float blue  = (0x999999 & 0x0000FF);
...
//        self.activityIndicatorView.color = color;
        ...
        self.titles = [NSMutableArray arrayWithObjects:NSLocalizedString(@"下拉开始加载...",),
...
- (void)layoutSubviews {
    ...
    titleFrame.origin.x = ceilf(remainingWidth*position+90);
    titleFrame.origin.y = self.bounds.size.height-(self.subtitleLabel.text ? 48 : 40)+5;
...
//    self.activityIndicatorView.center = self.arrow.center;
    self.gifImgView.frame = CGRectMake(65, 14, 78, 41);
...
-(UIImageView *)gifImgView
{
    if (!_gifImgView)
    {
        NSString* path = [[NSBundle mainBundle] pathForResource:@"guimi" ofType:@"gif"];
        _gifImgView = [[GIFImageView alloc] initWithFile:path];
        _gifImgView.frame = CGRectMake(0, self.bounds.size.height-53, 78, 41);
//        _gifImgView.image = [UIImage imageNamed:@"guimi-1"];
...
-(void)setGifImgView:(GIFImageView *)gifImgView
{
    self.gifImgView = gifImgView;
}
...
- (UIColor *)arrowColor
{
    float red   = (0xD0246C & 0xFF0000)>>16;
    float green = (0xD0246C & 0x00FF00)>>8;
    float blue  = (0xD0246C & 0x0000FF);
    UIColor* color = [UIColor colorWithRed:red/255 green:green/255 blue:blue/255 alpha:1.0];
